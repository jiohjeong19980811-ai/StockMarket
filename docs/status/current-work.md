...
Last updated: 2026-06-05T16:20:00-04:00
...
| Next step | Run an approved Vitest upgrade to a non-vulnerable release, then rerun root CI before PR merge. |
| Related docs/files | `packages/db/src/backtest-run-ledger.ts`, `packages/db/test/backtest-run-ledger.test.ts`, `apps/api/src/server.ts`, `apps/api/test/backtesting.test.ts`, `docs/backtesting-and-validation.md`, `docs/risk-and-compliance.md`, `docs/product-roadmap.md` |
